...
$__System.register("9", ["a", "b"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var Observable_1,
      Subject_1;
  ...
  exports_1("log", log);
  function readLog(verbosity) {
    return logStream.filter(function(entry) {
      return entry.verbosity <= logLevel;
    }).map(function(entry) {
      return entry.message;
    });
  }
  exports_1("readLog", readLog);
  function setLogLevel(verbosity) {
    logLevel = verbosity;
  }
  exports_1("setLogLevel", setLogLevel);
  function disableLogBuffering() {
    logBuffer = null;
  }
  exports_1("disableLogBuffering", disableLogBuffering);
  return {
    ...
    execute: function() {
      ...
      exports_1("Verbosity", Verbosity);
      logBuffer = [];
      logSubject = null;
      logLevel = Verbosity.INFO;
      logStream = Observable_1.Observable.create(function(observer) {
        if (logSubject === null) {
          logSubject = new Subject_1.Subject();
        }
        var buffered = Observable_1.Observable.empty();
        if (logBuffer !== null) {
          buffered = Observable_1.Observable.from(logBuffer);
          logBuffer = null;
        }
        return buffered.concat(logSubject).subscribe(observer);
      });
    }
  };
});

$__System.register("6", ["c"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var jshashes_1;
...
$__System.register("d", ["6", "c"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var manifest_1,
      jshashes_1;
...
$__System.register("e", ["a", "d", "f"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var Observable_1,
      manifest_parser_1,
...
$__System.register("7", ["a", "b", "9", "d", "e", "f"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var Observable_1,
      Subject_1,
  ...
  return {
    ...
    execute: function() {
      ...
      NOTIFICATION_OPTION_NAMES = ['actions', 'body', 'dir', 'icon', 'lang', 'renotify', 'requireInteraction', 'tag', 'vibrate', 'data'];
      ...
      exports_1("ManifestSource", ManifestSource);
      FetchFromCacheInstruction = (function() {
      ...
      ServiceWorker = (function() {
        function ServiceWorker(scope, events, fetch, cache, adapter) {
          var _this = this;
          this.scope = scope;
          this.events = events;
          this.fetch = fetch;
          ...
          this._manifest = null;
          this.pushBuffer = [];
          this.pushSubject = new Subject_1.Subject();
          this._pushShowNotification = false;
          this._pushBackgroundOnly = false;
          this.manifestReq = adapter.newRequest(MANIFEST_URL);
          this.pushes = Observable_1.Observable.create(function(observer) {
            _this.pushBuffer.forEach(function(item) {
              return observer.next(item);
            });
            _this.pushBuffer = null;
            var sub = _this.pushSubject.subscribe(observer);
            return function() {
              sub.unsubscribe();
              _this.pushBuffer = [];
            };
          ...
          events.install.subscribe(function(ev) {
            logging_1.log(logging_1.Verbosity.INFO, 'ngsw: Event - install');
            var init = _this.checkDiffs(ManifestSource.NETWORK).let(setup_1.buildCaches(cache, fetch)).let(operator_1.doAsync(function(delta) {
              ...
              return logging_1.log(logging_1.Verbosity.INFO, 'ngsw: Event - install complete');
            });
            ev.waitUntil(init.toPromise());
          });
          events.activate.subscribe(function(ev) {
            logging_1.log(logging_1.Verbosity.INFO, 'ngsw: Event - activate');
          ...
          events.message.filter(function(event) {
            return event.ports.length === 1 && event.data && event.data.hasOwnProperty('$ngsw');
          }).flatMap(function(event) {
            var respond = event.ports[0];
            return _this.handleMessage(event.data).do(function(response) {
              return respond.postMessage(response);
            }, undefined, function() {
              return respond.postMessage(null);
            }).ignoreElements();
          }).subscribe();
          events.push.map(function(ev) {
            return ev.data;
          }).map(function(data) {
            try {
              return data.json();
            ...
            if (!_this._pushShowNotification || !json.hasOwnProperty('notification')) {
              return;
            }
            if (_this._pushBackgroundOnly && _this.pushBuffer === null) {
              return;
            }
          }).subscribe(function(json) {
            if (_this.pushBuffer !== null) {
              _this.pushBuffer.push(json);
            } else {
              _this.pushSubject.next(json);
            }
          });
        }
        ...
        ServiceWorker.prototype.handleFetch = function(request, options) {
          ...
          return this.init.let(_handleRequest(request, options)).do(function(instruction) {
            return logging_1.log(logging_1.Verbosity.DETAIL, "ngsw: executing " + instruction.describe());
        ...
        ServiceWorker.prototype.handleMessage = function(message) {
          switch (message['cmd']) {
            case 'ping':
              return Observable_1.Observable.empty();
            case 'log':
              var level = logging_1.Verbosity.DETAIL;
              return logging_1.readLog(level);
            case 'push':
              return this.pushes;
            case 'setPushOptions':
              return this.setPushOptions(message['options']);
            default:
              logging_1.log(logging_1.Verbosity.TECHNICAL, "Unknown postMessage received: " + JSON.stringify(message));
              return Observable_1.Observable.empty();
          }
        };
        ServiceWorker.prototype.setPushOptions = function(options) {
          var _this = this;
          return Observable_1.Observable.create(function(observer) {
            if (options.hasOwnProperty('showNotification')) {
              _this._pushShowNotification = !!options['showNotification'];
            }
            if (options.hasOwnProperty('backgroundOnly')) {
              _this._pushBackgroundOnly = !!options['backgroundOnly'];
            }
            var serialized = JSON.stringify({
              showNotification: _this._pushShowNotification,
              backgroundOnly: _this._pushBackgroundOnly
            });
            return _this.cache.store('nsgw.push', _this.adapter.newRequest('/push-config.json'), _this.adapter.newResponse(serialized)).ignoreElements();
          });
        };
        ...
        ServiceWorker.prototype.showNotification = function(desc) {
          if (!desc.hasOwnProperty('title')) {
            return;
          }
          var options = {};
          NOTIFICATION_OPTION_NAMES.filter(function(name) {
            return desc.hasOwnProperty(name);
          }).forEach(function(name) {
            return options[name] = desc[name];
          });
...
$__System.register("5", ["a"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var Observable_1;
  var WorkerScope,
    ...
    execute: function() {
      ...
      Events = (function() {
        function Events(scope) {
          ...
          this.message = Observable_1.Observable.fromEvent(scope, 'message');
          this.push = Observable_1.Observable.fromEvent(scope, 'push');
        }
        return Events;
      }());
...
$__System.register("8", ["a", "f"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var Observable_1,
      operator_1;
...
$__System.register("4", ["a"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var Observable_1;
  var CacheManager;
...
$__System.registerDynamic("10", ["11", "12", "13", "14", "15"], true, function($__require, exports, module) {
  ...
  var ArrayObservable_1 = $__require('11');
  var isArray_1 = $__require('12');
  var isScheduler_1 = $__require('13');
  var OuterSubscriber_1 = $__require('14');
  var subscribeToResult_1 = $__require('15');
...
$__System.registerDynamic("16", ["a", "10"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("19", ["a", "17"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var Observable_1 = $__require('a');
  var concat_1 = $__require('17');
  Observable_1.Observable.concat = concat_1.concat;
  return module.exports;
});

$__System.registerDynamic("1a", ["a", "15", "14"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("1c", ["a", "1b"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("1f", ["a", "1d"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("20", ["21", "22", "23", "a", "24", "25", "26"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("27", ["a", "28", "1e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("29", ["12", "24", "2a", "13", "2b", "20", "11", "27", "2c", "25", "a", "2d"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("2f", ["a", "2e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("30", ["a", "23", "26", "31"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("33", ["a", "32"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("2b", ["21", "a"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("35", ["a", "34"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("36", ["11", "37", "13"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("39", ["a", "38"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("3b", ["a", "3a"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var Observable_1 = $__require('a');
  var of_1 = $__require('3a');
  Observable_1.Observable.of = of_1.of;
  return module.exports;
});

$__System.registerDynamic("3c", ["12"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("3d", ["3e", "3f"], true, function($__require, exports, module) {
  ...
  var FutureAction_1 = $__require('3e');
  var QueueScheduler_1 = $__require('3f');
...
$__System.registerDynamic("40", ["3d"], true, function($__require, exports, module) {
  ...
  var define,
      global = this,
      GLOBAL = this;
  var AsyncScheduler_1 = $__require('3d');
...
$__System.registerDynamic("42", ["3c", "a", "40", "13", "41"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var isNumeric_1 = $__require('3c');
  var Observable_1 = $__require('a');
  var async_1 = $__require('40');
  var isScheduler_1 = $__require('13');
  var isDate_1 = $__require('41');
...
$__System.registerDynamic("43", ["42"], true, function($__require, exports, module) {
  ...
  var define,
      global = this,
      GLOBAL = this;
  var TimerObservable_1 = $__require('42');
  exports.timer = TimerObservable_1.TimerObservable.create;
  return module.exports;
});

$__System.registerDynamic("44", ["a", "43"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("45", ["46"], true, function($__require, exports, module) {
  ...
  var define,
      global = this,
      GLOBAL = this;
  var publishReplay_1 = $__require('46');
...
$__System.registerDynamic("47", ["a", "45"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var Observable_1 = $__require('a');
  var cache_1 = $__require('45');
  Observable_1.Observable.prototype.cache = cache_1.cache;
  return module.exports;
});

$__System.registerDynamic("28", ["a"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("1e", ["a"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("11", ["a", "28", "1e", "13"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("37", ["14", "15"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("18", ["13", "11", "37"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("48", ["a", "18"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("4b", ["a", "49"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("4e", ["a", "4c"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("50", ["a", "4f"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("52", ["4d", "51"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("53", ["a", "52"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("55", ["4d", "54"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("56", ["a", "55"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var Observable_1 = $__require('a');
  var ignoreElements_1 = $__require('55');
...
$__System.registerDynamic("58", ["a", "57"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var Observable_1 = $__require('a');
  var let_1 = $__require('57');
  Observable_1.Observable.prototype.let = let_1.letProto;
  Observable_1.Observable.prototype.letBind = let_1.letProto;
  return module.exports;
});

$__System.registerDynamic("59", ["4d"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("5a", ["a", "59"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("15", ["21", "12", "2a", "a", "25", "2c", "5b"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var iterator_1 = $__require('25');
  var observable_1 = $__require('2c');
  var InnerSubscriber_1 = $__require('5b');
...
$__System.registerDynamic("14", ["4d"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("4a", ["15", "14"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("5c", ["a", "4a"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("5d", ["3e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("3e", ["21", "31"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("3f", ["5d", "3e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var QueueAction_1 = $__require('5d');
  var FutureAction_1 = $__require('3e');
...
$__System.registerDynamic("5e", ["3f"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("5f", ["a"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("2d", ["4d", "5f"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var Subscriber_1 = $__require('4d');
  var Notification_1 = $__require('5f');
...
$__System.registerDynamic("60", ["b", "5e", "2d"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var Subject_1 = $__require('b');
  var queue_1 = $__require('5e');
  var observeOn_1 = $__require('2d');
...
$__System.registerDynamic("46", ["60", "61"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("62", ["a", "46"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("63", ["4d"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("64", ["a", "63"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var Observable_1 = $__require('a');
  var reduce_1 = $__require('63');
  Observable_1.Observable.prototype.reduce = reduce_1.reduce;
  return module.exports;
});

$__System.registerDynamic("65", ["a", "4d", "31"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("61", ["65"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var ConnectableObservable_1 = $__require('65');
...
$__System.registerDynamic("66", ["31"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("b", ["a", "4d", "31", "66", "69", "67", "68"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var Subscriber_1 = $__require('4d');
  var Subscription_1 = $__require('31');
  var SubjectSubscription_1 = $__require('66');
  var rxSubscriber_1 = $__require('69');
  var throwError_1 = $__require('67');
  var ObjectUnsubscribedError_1 = $__require('68');
...
$__System.registerDynamic("6a", ["61", "b"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("6b", ["a", "6a"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("31", ["12", "22", "24", "23", "26", "6c"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var tryCatch_1 = $__require('23');
  var errorObject_1 = $__require('26');
  var UnsubscriptionError_1 = $__require('6c');
...
$__System.registerDynamic("4d", ["24", "31", "69", "6d"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("69", ["21"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("6e", ["4d", "69"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("a", ["21", "2c", "6e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var root_1 = $__require('21');
  var observable_1 = $__require('2c');
  var toSubscriber_1 = $__require('6e');
...
$__System.registerDynamic("70", ["a", "6f"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
      GLOBAL = this;
  var Observable_1 = $__require('a');
  var toPromise_1 = $__require('6f');
  Observable_1.Observable.prototype.toPromise = toPromise_1.toPromise;
  return module.exports;
});

$__System.register("3", ["16", "19", "1c", "1f", "2f", "33", "35", "39", "3b", "44", "47", "48", "4b", "4e", "50", "53", "56", "58", "5a", "5c", "62", "64", "6b", "70"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  return {
    setters: [function(_1) {}, function(_2) {}, function(_3) {}, function(_4) {}, function(_5) {}, function(_6) {}, function(_7) {}, function(_8) {}, function(_9) {}, function(_10) {}, function(_11) {}, function(_12) {}, function(_13) {}, function(_14) {}, function(_15) {}, function(_16) {}, function(_17) {}, function(_18) {}, function(_19) {}, function(_20) {}, function(_21) {}, function(_22) {}, function(_23) {}, function(_24) {}],
    execute: function() {}
  };
});

$__System.register("1", ["2", "7", "5", "8", "4", "3"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __extends = (this && this.__extends) || function(d, b) {
    for (var p in b)
  ...
  return {
    ...
    execute: function() {
      ...
      worker = new worker_1.ServiceWorker(workerScope, events, fetch, cacheManager, workerAdapter);
    }
  };
});
